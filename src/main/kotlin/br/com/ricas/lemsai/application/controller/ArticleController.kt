...
//        }
    ...
    private fun getArticle() =
        Article(
            ...
            title = "Introdução ao universo corinthiano: história, tradição e paixão",
            sections = listOf(
                Section(
                order = 0,
                title = "Introdução ao Mundo do Foo Fighters: Descubra a Ascensão e o Legado Dessa Banda Icônica ",
                isSubSection = false,
                ...
                Section(
                    order = 1,
                    title = "Seção 1: O Despertar do Foo Fighters: Uma Jornada Pelas Raízes e Influências da Banda Icônica ",
                    isSubSection = false,
                ...
                Section(
                    order = 2,
                    title = "SubSeção 1: As Raízes e Influências do Foo Fighters: Um Despertar Musical na Seção 1 ",
                    isSubSection = true,
